...
all_phase17={
 'registerFinanceReportsFinalV7','registerStatementRenderUnifiedV7','registerFiscalScopeReportingOverrideV7',
 'registerHistoricalReportingOverrideV7','registerStatementRenderOverrideV7','registerYearEndCalculateOverrideV7',
 'registerYearEndOpeningOverrideV7','registerYearEndFinalV7','registerYearEndV7Routes',
 'registerStatementDesignerV7Routes','registerComplianceControlOverrideV7','registerComplianceV7Routes'
}
...
if "phase17-ui.js" not in f:
    if "load('/phase16-ui.js');" in f: f=f.replace("load('/phase16-ui.js');","load('/phase16-ui.js');load('/phase17-ui.js');",1)
    else: f=f.replace('})();',"load('/phase17-ui.js');})();",1)
fa.write_text(f,encoding='utf-8')
print('Phase 1.7 authoritative route wiring complete')
