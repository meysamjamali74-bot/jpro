...
app.get('/api/health', async (_req,res)=>{try{res.json({ok:await healthCheck(),service:'tarazpad-api',version:'0.3.0'})}catch(e){res.status(503).json({ok:false,error:e.message})}});
